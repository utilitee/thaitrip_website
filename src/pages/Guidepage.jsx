          ...
          <div className="grid md:grid-cols-2 gap-2">
            <div className=" bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all">
              <h3 className="text-lg font-medium text-gray-800 text-center">
                🔥 เล่นกับ AI เหมือนเพื่อนสนิท
              </h3>
              <p className="text-gray-600 text-center">
                ลองถามคำถามแปลก ๆ หรือขอคำแนะนำในแบบสนุก ๆ เช่น "มีร้านอาหารลับ
                ๆ ไหม?" หรือ "อยากหาที่พักวิวดีแต่ราคาน่ารัก มีที่ไหนแนะนำ?"
              </p>
            </div>
